...
{
    [TestClass]
    public class GetHourNumberTests
    {
        ...
        [TestMethod]
        public void GetHourNumber_Valid_Hour_User_Local()
        {
            //Arrange
            ...
            //Act
            var result = xrmFakedContext.ExecuteCodeActivity<GetHourNumber>(workflowContext, inputs);

            //Assert
            Assert.AreEqual(expected, result["HourNumber"]);
        }

        [TestMethod]
        public void GetHourNumber_Valid_Hour_Utc()
        {
            //Arrange
            XrmFakedWorkflowContext workflowContext = new XrmFakedWorkflowContext();
