...
{
    [TestClass]
    public class DateDiffBusinessDaysTests
    {
        ...
        [TestMethod]
        public void DateDiffBusinessDays_Minus_One_Day()
        {
            //Arrange
            ...
            //Act
            var result = xrmFakedContext.ExecuteCodeActivity<DateDiffBusinessDays>(workflowContext, inputs);
        ...
        [TestMethod]
        public void DateDiffBusinessDays_One_Hour()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessDays_30_Minutes()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessDays_90_Minutes()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessDays_Minus_90_Minutes()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessDays_Minus_One_Hour()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessDays_Same_DateTime()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessDays_Six_Days_With_Weekend_Between()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessDays_Minus_Six_Days_With_Weekend_Between()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessDays_Three_Days_Weekend_And_2_Full_Day_Holidays()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessDays_Minus_Three_Days_Weekend_And_2_Full_Day_Holidays()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessDays_Three_And_A_Half_Days_Half_Day_Holiday()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
