...
{
    [TestClass]
    public class GetNumberOfBusinessHoursTests
    {
        ...
        [TestMethod]
        public void GetNumberOfBusinessHours_One_Day_In_Range()
        {
            //Arrange
            ...
            //Act
            var result = xrmFakedContext.ExecuteCodeActivity<GetNumberOfBusinessHours>(workflowContext, inputs);

            //Assert
            Assert.AreEqual(expected, result["NumberOfBusinessHours"]);
        }

        [TestMethod]
        public void GetNumberOfBusinessHours_Six_Days_With_Weekend_Between()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void GetNumberOfBusinessHours_Four_Days_Weekend_And_Easter()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
