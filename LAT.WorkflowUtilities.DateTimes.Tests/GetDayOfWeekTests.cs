...
namespace LAT.WorkflowUtilities.DateTimes.Tests
{
    ...
    public class GetDayOfWeekTests
    {
        ...
        [TestMethod]
        public void GetDayOfWeek_Valid_Day_User_Local()
        {
            //Arrange
            ...
            //Act
            var result = xrmFakedContext.ExecuteCodeActivity<GetDayOfWeek>(workflowContext, inputs);

            //Assert
            Assert.AreEqual(expected, result["DayOfWeek"]);
        }

        [TestMethod]
        public void GetDayOfWeek_Valid_Day_Utc()
        {
            //Arrange
            XrmFakedWorkflowContext workflowContext = new XrmFakedWorkflowContext();
