...
{
    [TestClass]
    public class GetSecondNumberTests
    {
        ...
        [TestMethod]
        public void GetSecondNumber_Valid_Second_User_Local()
        {
            //Arrange
            ...
            {
                { "DateToUse", new DateTime(2015, 1, 1, 5, 10, 15, DateTimeKind.Utc) },
            ...
            //Act
            var result = xrmFakedContext.ExecuteCodeActivity<GetSecondNumber>(workflowContext, inputs);

            //Assert
            Assert.AreEqual(expected, result["SecondNumber"]);
        }

        [TestMethod]
        public void GetSecondNumber_Valid_Second_Utc()
        {
            //Arrange
            XrmFakedWorkflowContext workflowContext = new XrmFakedWorkflowContext();
        ...
        private class FakeLocalTimeFromUtcTimeRequestExecutor : IFakeMessageExecutor
        {
            ...
            public OrganizationResponse Execute(OrganizationRequest request, XrmFakedContext ctx)
            {
                ...
                ParameterCollection results = new ParameterCollection { { "LocalTime", new DateTime(2014, 12, 31, 23, 10, 15) } };
