...
namespace LAT.WorkflowUtilities.DateTimes.Tests
{
    ...
    public class GetDayNumberOfYearTests
    {
        ...
        [TestMethod]
        public void GetDayNumberOfYear_Valid_Day_User_Local()
        {
            //Arrange
            ...
            //Act
            var result = xrmFakedContext.ExecuteCodeActivity<GetDayNumberOfYear>(workflowContext, inputs);

            //Assert
            Assert.AreEqual(expected, result["DayNumberOfYear"]);
        }

        [TestMethod]
        public void GetDayNumberOfYear_Valid_Day_Utc()
        {
            //Arrange
            XrmFakedWorkflowContext workflowContext = new XrmFakedWorkflowContext();
