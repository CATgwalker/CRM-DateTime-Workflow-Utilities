...
namespace LAT.WorkflowUtilities.DateTimes.Tests
{
    ...
    public class GetDayNumberOfWeekTests
    {
        ...
        [TestMethod]
        public void GetDayNumberOfWeek_Valid_Day_User_Local()
        {
            //Arrange
            ...
            //Act
            var result = xrmFakedContext.ExecuteCodeActivity<GetDayNumberOfWeek>(workflowContext, inputs);

            //Assert
            Assert.AreEqual(expected, result["DayNumberOfWeek"]);
        }

        [TestMethod]
        public void GetDayNumberOfWeek_Valid_Day_Utc()
        {
            //Arrange
            XrmFakedWorkflowContext workflowContext = new XrmFakedWorkflowContext();
