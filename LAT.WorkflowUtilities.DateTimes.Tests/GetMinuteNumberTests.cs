...
{
    [TestClass]
    public class GetMinuteNumberTests
    {
        ...
        [TestMethod]
        public void GetMinuteNumber_Valid_Minute_User_Local()
        {
            //Arrange
            ...
            {
                { "DateToUse", new DateTime(2015, 1, 1, 5, 10, 0, DateTimeKind.Utc) },
            ...
            //Act
            var result = xrmFakedContext.ExecuteCodeActivity<GetMinuteNumber>(workflowContext, inputs);

            //Assert
            Assert.AreEqual(expected, result["MinuteNumber"]);
        }

        [TestMethod]
        public void GetMinuteNumber_Valid_Minute_Utc()
        {
            //Arrange
            XrmFakedWorkflowContext workflowContext = new XrmFakedWorkflowContext();
        ...
        private class FakeLocalTimeFromUtcTimeRequestExecutor : IFakeMessageExecutor
        {
            ...
            public OrganizationResponse Execute(OrganizationRequest request, XrmFakedContext ctx)
            {
                ...
                ParameterCollection results = new ParameterCollection { { "LocalTime", new DateTime(2014, 12, 31, 23, 10, 0) } };
