...
namespace LAT.WorkflowUtilities.DateTimes.Tests
{
    ...
    public class GetDayNumberTests
    {
        ...
        [TestMethod]
        public void GetDayNumber_Valid_Day_User_Local()
        {
            //Arrange
            ...
            //Act
            var result = xrmFakedContext.ExecuteCodeActivity<GetDayNumber>(workflowContext, inputs);

            //Assert
            Assert.AreEqual(expected, result["DayNumber"]);
        }

        [TestMethod]
        public void GetDayNumber_Valid_Day_Utc()
        {
            //Arrange
            XrmFakedWorkflowContext workflowContext = new XrmFakedWorkflowContext();
