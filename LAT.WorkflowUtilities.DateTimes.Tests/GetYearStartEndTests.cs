...
namespace LAT.WorkflowUtilities.DateTimes.Tests
{
    ...
    public class GetYearStartEndTests
    {
        ...
        [TestMethod]
        public void GetYearStartEnd_Valid_Date1_User_Local()
        {
            //Arrange
            ...
            //Act
            var result = xrmFakedContext.ExecuteCodeActivity<GetYearStartEnd>(workflowContext, inputs);

            //Assert
            Assert.AreEqual(expected1, result["YearStartDate"]);
            Assert.AreEqual(expected2, result["YearEndDate"]);
        }

        [TestMethod]
        public void GetYearStartEnd_Valid_Date1_Utc()
        {
            //Arrange
            XrmFakedWorkflowContext workflowContext = new XrmFakedWorkflowContext();
