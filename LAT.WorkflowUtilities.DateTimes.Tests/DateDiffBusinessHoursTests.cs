...
{
    [TestClass]
    public class DateDiffBusinessHoursTests
    {
        ...
        [TestMethod]
        public void DateDiffBusinessHours_Minus_One_Day()
        {
            //Arrange
            ...
            //Act
            var result = xrmFakedContext.ExecuteCodeActivity<DateDiffBusinessHours>(workflowContext, inputs);
        ...
        [TestMethod]
        public void DateDiffBusinessHours_One_Hour()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessHours_30_Minutes()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
            ...
            {
                { "StartingDate", new DateTime(2018, 3, 27, 11, 0, 0, 0)},
                { "EndingDate", new DateTime(2018, 3, 27, 11, 31, 0, 0)},
                { "HolidayClosureCalendar", null }
            };
        ...
        [TestMethod]
        public void DateDiffBusinessHours_90_Minutes()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
            ...
            {
                { "StartingDate", new DateTime(2018, 3, 27, 11, 0, 0, 0)},
                { "EndingDate", new DateTime(2018, 3, 27, 12, 31, 0, 0)},
                { "HolidayClosureCalendar", null }
            };
        ...
        [TestMethod]
        public void DateDiffBusinessHours_Minus_90_Minutes()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
            ...
            var inputs = new Dictionary<string, object>
            {
                { "StartingDate", new DateTime(2018, 3, 27, 12, 31, 0, 0)},
        ...
        [TestMethod]
        public void DateDiffBusinessHours_Minus_One_Hour()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessHours_Same_DateTime()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessHours_Six_Days_With_Weekend_Between()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessHours_Minus_Six_Days_With_Weekend_Between()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessHours_Three_Days_Weekend_And_2_Full_Day_Holidays()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessHours_Minus_Three_Days_Weekend_And_2_Full_Day_Holidays()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void DateDiffBusinessHours_Three_And_A_Half_Days_Half_Day_Holiday()
        {
            //Arrange
            var workflowContext = new XrmFakedWorkflowContext();
