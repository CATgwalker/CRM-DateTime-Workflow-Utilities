...
namespace LAT.WorkflowUtilities.DateTimes.Tests
{
    ...
    public class GetMonthNumberTests
    {
        ...
        [TestMethod]
        public void GetMonthNumber_Valid_Day_User_Local()
        {
            //Arrange
            ...
            //Act
            var result = xrmFakedContext.ExecuteCodeActivity<GetMonthNumber>(workflowContext, inputs);

            //Assert
            Assert.AreEqual(expected, result["MonthNumber"]);
        }

        [TestMethod]
        public void GetMonthNumber_Valid_Day_Utc()
        {
            //Arrange
            XrmFakedWorkflowContext workflowContext = new XrmFakedWorkflowContext();
