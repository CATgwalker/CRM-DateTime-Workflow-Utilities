...
namespace LAT.WorkflowUtilities.DateTimes.Tests
{
    ...
    public class AddYearsTests
    {
        ...
        [TestMethod]
        public void AddYears_Add_Plus_One()
        {
            //Arrange
            ...
            //Act
            var result = xrmFakedContext.ExecuteCodeActivity<AddYears>(workflowContext, inputs);
        ...
        [TestMethod]
        public void AddYears_Add_Plus_Five()
        {
            //Arrange
            XrmFakedWorkflowContext workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void AddYears_Add_Plus_Fifty()
        {
            //Arrange
            XrmFakedWorkflowContext workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void AddYears_Add_Minus_One()
        {
            //Arrange
            XrmFakedWorkflowContext workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void AddYears_Add_Minus_Five()
        {
            //Arrange
            XrmFakedWorkflowContext workflowContext = new XrmFakedWorkflowContext();
        ...
        [TestMethod]
        public void AddYears_Add_Minus_Fifty()
        {
            //Arrange
            XrmFakedWorkflowContext workflowContext = new XrmFakedWorkflowContext();
